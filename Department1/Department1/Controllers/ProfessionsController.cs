...
namespace Department1.Controllers
{
    public class ProfessionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameProfession")] Profession profession)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameProfession")] Profession profession)
        {
            if (id != profession.Id)
            {
                return NotFound();
